    ...
    <div className="space-y-6" id="d3-traffic-demo-container">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 rounded-xl bg-white dark:bg-[#161b22] border border-[#dfe3e9] dark:border-[#30363d] shadow-xs">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {/* Time Range Filter */}
          <div className="inline-flex p-1 rounded-lg bg-[#f6f7f9] dark:bg-[#0e1116] border border-[#dfe3e9] dark:border-[#30363d]">
            ...
            <button
              ...
              className={`px-2.5 py-1 text-xs font-mono rounded-md transition-all cursor-pointer ${
                activeMetric === 'all'
                  ...
                  : 'text-[#5c6472] dark:text-[#8b93a1] hover:text-[#101318]'
              }`}
            >
              All Funnel
            </button>
