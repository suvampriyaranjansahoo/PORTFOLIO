    ...
    <section id="academics" className="py-16 sm:py-20 border-t border-[#dfe3e9] dark:border-[#262c36]">
      <div className="max-w-[1160px] mx-auto px-5 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 mb-8">
          <div className="p-4 rounded-2xl bg-white dark:bg-[#151920] border border-[#dfe3e9] dark:border-[#262c36] shadow-xs flex items-center gap-3.5 h-full">
            <div className="p-2.5 rounded-xl bg-amber-500/10 text-[#a66a12] shrink-0">
            ...
            <div>
              ...
              <div className="text-[11px] text-[#5c6472] dark:text-[#8b93a1]">ITER, SOA University (2022–2026)</div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white dark:bg-[#151920] border border-[#dfe3e9] dark:border-[#262c36] shadow-xs flex items-center gap-3.5 h-full">
            ...
            <div>
              ...
              <div className="text-[11px] text-[#5c6472] dark:text-[#8b93a1]">Saraswati Vidya Mandir, Berhampur (2021)</div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white dark:bg-[#151920] border border-[#dfe3e9] dark:border-[#262c36] shadow-xs flex items-center gap-3.5 h-full">
            ...
            <div>
              ...
              <div className="text-[11px] text-[#5c6472] dark:text-[#8b93a1]">SSVM, Nayagarh (2019)</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-12">
            ...
            {ACADEMIC_MILESTONES.map((m) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-2xl transition-all cursor-pointer flex flex-col justify-between border shadow-xs ${
                    isSelected
                      ? 'bg-white dark:bg-[#151920] border-[#a66a12] dark:border-[#a66a12] ring-1 ring-[#a66a12]'
                      : 'bg-white/70 dark:bg-[#151920]/70 border-[#dfe3e9] dark:border-[#262c36] hover:border-[#8b93a1]'
                  }`}
                >
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <span className="px-2 py-0.5 rounded-full text-[10px] font-mono font-semibold uppercase bg-amber-500/10 text-[#a66a12] border border-amber-500/20">
                      {m.badge}
                    </span>
                  ...
                  <div className="text-xs text-[#5c6472] dark:text-[#8b93a1] mt-1 truncate">
                    {m.institution}
                  </div>

                  <div className="mt-3 pt-2.5 border-t border-[#dfe3e9] dark:border-[#262c36] flex items-center justify-between w-full">
          ...
          <div className="lg:col-span-8">
            <div className="h-full p-6 sm:p-7 rounded-2xl bg-white dark:bg-[#151920] border border-[#dfe3e9] dark:border-[#262c36] shadow-xs flex flex-col justify-between space-y-6">
              <div>
                {/* Header Strip */}
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 pb-5 border-b border-[#dfe3e9] dark:border-[#262c36]">
                  <div>
                    <div className="flex items-center gap-2 mb-1.5">
                      <span className="px-2.5 py-0.5 rounded-full text-xs font-mono font-bold uppercase bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-500/20">
              ...
              <div className="pt-4 border-t border-[#dfe3e9] dark:border-[#262c36] flex items-center justify-between text-xs text-[#8b93a1]">
                ...
                <span className="font-mono text-[11px] text-[#a66a12] font-semibold">{t?.verifiedCandidate || "Verified Candidate"}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {ACADEMIC_DOMAINS.map((domain, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-5 rounded-2xl bg-white dark:bg-[#151920] border border-[#dfe3e9] dark:border-[#262c36] shadow-xs hover:border-[#a66a12] transition-colors"
                >
                  <div className="flex items-center gap-2.5 mb-3.5">
                    <span className="p-2 rounded-xl bg-amber-500/10 text-[#a66a12]">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {domain.skills.map((skill, sIdx) => (
                      <span key={sIdx} className="px-2 py-0.5 rounded-md text-[11px] font-mono bg-[#f6f7f9] dark:bg-[#0e1116] border border-[#dfe3e9] dark:border-[#262c36] text-[#5c6472] dark:text-[#9ea7b4]">
                        {skill}
                      </span>
                    ))}
                  </div>
