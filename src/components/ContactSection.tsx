    ...
    <section id="contact" className="section-ambient-container ambient-theme-warm py-16 sm:py-20 border-t border-[#fecdd3] dark:border-[#262c36] overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1160px] mx-auto px-5 sm:px-6 space-y-12">
        ...
        <div className="card-level-2 p-6 sm:p-8">
          <div className="font-mono text-xs text-[#e11d48] dark:text-[#fbbf24] tracking-widest uppercase mb-2">
            {t?.exploringLabel || "08 · CURRENTLY EXPLORING"}
          </div>
          <h3 className="font-display font-bold text-xl sm:text-2xl text-[#2d151c] dark:text-white mb-2">
            {t?.exploringHeading || "Business Analyst · Data Analyst · Product Analyst · Data Engineer · AI/ML Engineer"}
          </h3>
          <p className="text-sm text-[#643644] dark:text-[#9ea7b4] leading-relaxed max-w-3xl">
        ...
        {/* Contact Card */}
        <div className="card-level-1 p-8 sm:p-12 !bg-[#1b0e14]/95 dark:!bg-[#131823]/80 backdrop-blur-xl text-white border-rose-950/40 dark:border-white/[0.12] shadow-2xl flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="space-y-4">
            <div className="font-mono text-xs text-rose-300 dark:text-[#d8a34f] tracking-widest uppercase">
            ...
            <div className="flex items-center gap-2 text-sm text-rose-200/90 font-mono pt-1">
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
            ...
            <a
              ...
              className="btn-primary px-5 py-3 text-sm focus-visible:ring-2 focus-visible:ring-[#e11d48] focus-visible:ring-offset-2 dark:focus-visible:ring-offset-[#131823] focus-visible:outline-none"
            >
            ...
            <button
              ...
              onClick={onCopyEmail}
              className="inline-flex items-center gap-2 px-4 py-3 rounded-xl bg-white/10 hover:bg-white/15 border border-white/20 text-white text-sm font-mono transition-all cursor-pointer shadow-2xs focus-visible:ring-2 focus-visible:ring-[#e11d48] focus-visible:ring-offset-2 dark:focus-visible:ring-offset-[#131823] focus-visible:outline-none"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 px-4 py-3 rounded-xl bg-white/10 hover:bg-white/15 border border-white/20 text-[#e2e8f0] hover:text-white text-sm font-mono transition-all shadow-2xs focus-visible:ring-2 focus-visible:ring-[#e11d48] focus-visible:ring-offset-2 dark:focus-visible:ring-offset-[#131823] focus-visible:outline-none"
            >
              <span>LinkedIn</span>
        ...
        {/* Footer */}
        <footer className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 font-mono text-xs text-[#a06b7a] dark:text-[#8b93a1]">
          ...
          {onToggleMotion && (
            <button
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border border-rose-200 dark:border-white/10 bg-white/70 dark:bg-white/5 hover:bg-white dark:hover:bg-white/10 text-[#643644] dark:text-slate-300 transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-[#e11d48] focus-visible:outline-none"
            >
              ...
              {systemPrefersReducedMotion && (
                <span className="text-[10px] text-rose-600 dark:text-amber-400 font-mono">(OS Default)</span>
              )}
            </button>
          )}
